    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejected_contract_count', models.IntegerField(default=0, null=True)),
                ...
                ('available_time_slots', models.ManyToManyField(blank=True, related_name='timeslot', to='tutor.timeslot')),
